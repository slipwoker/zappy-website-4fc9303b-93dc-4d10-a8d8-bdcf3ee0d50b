document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (required && value === '') {
        ...
        const labelText = label ? label.textContent.replace('*', '').trim() : name;
  ...
  const animatedElements = document.querySelectorAll(
    '.animate-on-scroll, [data-animate], .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .blog-card, .gallery-item, .stat-item, .step-item'
  );
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Umi Sushi uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4fc9303b-93dc-4d10-a8d8-bdcf3ee0d50b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4fc9303b-93dc-4d10-a8d8-bdcf3ee0d50b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4fc9303b-93dc-4d10-a8d8-bdcf3ee0d50b';
